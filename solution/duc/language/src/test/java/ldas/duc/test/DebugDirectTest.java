...
public class DebugDirectTest {
    ...
    private static Source createInteropComputation() {
        return Source.newBuilder("duc", "function test() {\n" +
                        ...
                        "  }\n" +
                        "  return executing;\n" +
                        "}\n", "interopComputation.duc").buildLiteral();
    }
    ...
    public void testBreakpoint() throws Throwable {
        ...
        Value value = context.getBindings("duc").getMember("test").execute();
        assertExecutedOK();
    ...
    public void stepInStepOver() throws Throwable {
        ...
        Value value = context.getBindings("duc").getMember("test");
    ...
    public void testPause() throws Throwable {
        ...
        Value value = context.getBindings("duc").getMember("interopFunction").execute(nh);
    ...
    private static Source createNull() {
        return Source.newBuilder("duc", "function nullTest() {\n" +
                        "  res = doNull();\n" +
                        "  return res;\n" +
                        "}\n" +
                        "function doNull() {\n" +
                        "}\n", "nullTest.duc").buildLiteral();
    }
    ...
    public void testNull() throws Throwable {
        ...
        Value value = context.getBindings("duc").getMember("nullTest").execute();
        assertExecutedOK();
