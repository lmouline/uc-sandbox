...
public class InteropOperatorTest {
    ...
    public void testAdd() throws IOException {
        final Source src = Source.newBuilder("duc", "function testAdd(a,b) {return a + b;} function main() {return testAdd;}", "testAdd.duc").build();
    ...
    public void testSub() throws IOException {
        final Source src = Source.newBuilder("duc", "function testSub(a,b) {return a - b;} function main() {return testSub;}", "testSub.duc").build();
        final Value fnc = context.eval(src);
        final Value res = fnc.execute(1, 2);
        Assert.assertTrue(res.isNumber());
