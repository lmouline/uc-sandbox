...
import ldas.duc.nodes.access.*;
import ldas.duc.nodes.access.ReadPropertyCacheNodeGen;
 ...
 */
@MessageResolution(receiverType = ObjectType.class)
public class ObjectMessageResolution {
    ...
    public abstract static class SLForeignInvokeNode extends Node {
        ...
        @Child private DispatchNode dispatch = DispatchNodeGen.create();
        ...
        public Object access(DynamicObject receiver, String name, Object[] arguments) {
            ...
            if (property instanceof Function) {
                ...
                // Before the arguments can be used by the Function, they need to be converted to
                // SL
                // values.
