...
import ldas.duc.nodes.expression.UnboxNodeGen;

/**
 * The loop body of a {@link WhileNode while loop}. A Truffle framework {@link LoopNode} between
 * the {@link WhileNode} and {@link WhileRepeatingNode} allows Truffle to perform loop
...
public final class WhileRepeatingNode extends Node implements RepeatingNode {
    ...
    /**
     * The condition of the loop. This in a {@link ExpressionNode} because we require a result
    ...
    /** Statement (or {@link BlockNode block}) executed as long as the condition is true. */
    ...
    public WhileRepeatingNode(ExpressionNode conditionNode, StatementNode bodyNode) {
    ...
    public String toString() {
        return StatementNode.formatSourceSection(this);
    }
