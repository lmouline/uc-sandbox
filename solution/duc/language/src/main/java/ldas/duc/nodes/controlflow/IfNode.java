...
public final class IfNode extends StatementNode {
    ...
    /**
     * The condition of the {@code if}. This in a {@link ExpressionNode} because we require a
    ...
    /** Statement (or {@link BlockNode block}) executed when the condition is true. */
    @Child private StatementNode thenPartNode;

    /** Statement (or {@link BlockNode block}) executed when the condition is false. */
    ...
    private boolean evaluateCondition(VirtualFrame frame) {
        try {
             ...
             * program.
             */
            throw DucException.typeError(this, ex.getResult());
        }
    }
}
