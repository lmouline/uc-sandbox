...
public abstract class WritePropertyCacheNode extends PropertyCacheNode {
     ...
     * guard of {@link WritePropertyCacheNode#writeNewPropertyCached} because there we perform a
    ...
    public static WritePropertyCacheNode create() {
        return WritePropertyCacheNodeGen.create();
    }
