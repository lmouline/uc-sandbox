...
import ldas.duc.nodes.BinaryNode;
...
public abstract class EqualNode extends BinaryNode {
    ...
    @Specialization
    @TruffleBoundary
    protected boolean equal(BigNumber left, BigNumber right) {
    ...
    @Specialization
    protected boolean equal(Null left, Null right) {
        /* There is only the singleton instance of Null, so we do not need equals(). */
        return left == right;
    }
    ...
    protected Object typeError(Object left, Object right) {
        throw DucException.typeError(this, left, right);
    }
}
