 ...
 * user-defined functions. It handles the return value of a function: the {@link ReturnNode return
 * statement} throws an {@link ReturnException exception} with the return value. This node catches
 * the exception. If the method ends without an explicit {@code return}, return the
 * {@link Null#SINGLETON default null value}.
 */
...
public final class FunctionBodyNode extends ExpressionNode {
     ...
     * {@link ReturnNode explicit return statement}. This allows the compiler to generate better
     * code.
     */
